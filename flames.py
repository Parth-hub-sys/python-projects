...
#     result = [letter for letter in p1 if letter.lower() not in common_letters]
#     result += [letter for letter in p2 if letter.lower() not in common_letters]
#     return result

# # def selection(n):
# #     r = ["Friends", "Love", "Affection", "Marriage", "Enemy", "Siblings"]
# #     return r[n-1]  # return the nth element from the list

# p1 = input("enter person-1 name : ")
# p2 = input("enter person-2 name : ")

# result = remove(p1, p2)
# n = len(result)  # get the count of uncommon letters
# print("Uncommon letters:", n)

# # remove the nth element from the r list till the end
# r = ["Friends", "Love", "Affection", "Marriage", "Enemy", "Siblings"]
# r = r[:n-1]  # slice the list up to the nth element
# print(r)
...
# print("Relationship:", r[-1])  # print the last element of the sliced list
